...
namespace WalletConnectUnity.Modal.Sample
{
    public class Chain
    {
        ...
        public static readonly Chain Ethereum =
            new Chain(EvmNamespace, "1", nameof(Ethereum), new Color(0.38f, 0.49f, 0.92f));

        public static readonly Chain Optimism =
            new Chain(EvmNamespace, "10", nameof(Optimism), new Color(0.91f, 0f, 0f));

        public static readonly Chain
            xDai = new Chain(EvmNamespace, "100", nameof(xDai), new Color(0.28f, 0.66f, 0.65f));

        public static readonly Chain Polygon =
            new Chain(EvmNamespace, "137", nameof(Polygon), new Color(0.51f, 0.28f, 0.9f));

        public static readonly Chain Arbitrum =
            new Chain(EvmNamespace, "42161", nameof(Arbitrum), new Color(0.17f, 0.22f, 0.29f));

        public static readonly Chain Celo = new Chain(EvmNamespace, "42220", nameof(Celo),
            new Color(0.21f, 0.82f, 0.5f));

        public static readonly Chain EthereumGoerli =
            new Chain(EvmNamespace, "5", "Ethereum Goerli", new Color(0.38f, 0.49f, 0.92f), true);

        public static readonly Chain OptimismGoerli =
            new Chain(EvmNamespace, "420", "Optimism Goerli", new Color(0.91f, 0f, 0f), true);

        public static readonly Chain Mumbai = new Chain(EvmNamespace, "80001", nameof(Mumbai),
            new Color(0.51f, 0.28f, 0.9f), true);

        public static readonly Chain ArbitrumRinkeby =
            new Chain(EvmNamespace, "421611", "Arbitrum Rinkeby", new Color(0.17f, 0.22f, 0.29f), true);

        public static readonly Chain CeloAlfajores =
            new Chain(EvmNamespace, "44787", "Celo Alfajores", new Color(0.21f, 0.82f, 0.5f), true);
